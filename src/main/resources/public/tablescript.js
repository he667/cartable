...
var labels_schema = ["PROD", "PROD", "PROD", "PROD", "PROD", "PROD", "TEST", "TEST", "TEST", "TEST", "TEST", "TEST"]             
var labels_name = ["WP_COMMENTMETA", "WP_COMMENTS", "WP_LINKS", "WP_OPTIONS", "WP_POSTMETA", "WP_POSTS", "WP_TERMS", "WP_TERMMETA", "WP_TERM_RELATIONSHIPS", "WP_TERM_TAXONOMY", "WP_USERMETA", "WP_USERS",
					"WP_COMMENTMETA", "WP_COMMENTS", "WP_LINKS", "WP_OPTIONS", "WP_POSTMETA", "WP_POSTS", "WP_TERMS", "WP_TERMMETA", "WP_TERM_RELATIONSHIPS", "WP_TERM_TAXONOMY", "WP_USERMETA", "WP_USERS"]             
var labels_update = ["10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00",
					"10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00"]             
var labels_events = ["10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00",
					"10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00","10/02/2018 17:00:00"]             
...
for (var i = 0; i < MapRows; i++) {
    for (var j = 0; j < MapColumns; j++) {
    	if (i * MapColumns + j < labels_name.length ) {
        	points.push([j * (blockWidth + blockSpacing), i *  (blockHeight + 2/3*blockHeight + 3*blockSpacing) ]);
		truePoints.push([j * (blockWidth + blockSpacing), i * (blockHeight + 2/3*blockHeight + 3*blockSpacing) ]);
		}
    }//for j
}//for i
...
svg.append("g")
    ...
    .attr("class", "rect_pk")
    .attr("x",function (d,i) {return d[0] ;})
    .attr("y", function (d,i) {return d[1] + blockHeight + blockSpacing;})
...
// functional date status
svg.append("g")
    .selectAll(".rect_fd")
    .data(points)
    .enter().append("rect")
    .attr("class", "rect_fd")
    .attr("x",function (d,i) {return blockWidth / 3 + d[0] ;})
    .attr("y", function (d,i) {return d[1] + blockHeight + blockSpacing;})
    .attr("width", blockWidth / 3 )
    .attr("height", blockHeight / 4 )
    .attr("stroke", "white")
...
svg.append("g")
    ...
    .enter().append("rect")
    .attr("class", "rect_fd")
    .attr("x",function (d,i) {return 2 * blockWidth / 3 + d[0] ;})
    .attr("y", function (d,i) {return d[1] + blockHeight + blockSpacing;})
    .attr("width", blockWidth / 3 )
    .attr("height", blockHeight / 4 )
    .attr("stroke", "white")
...
svg.selectAll(".text_schema")
	.data(points)
	.enter().append("text")
	.attr("class", "text_schema")
    .attr("x",function (d,i) {return textSpacing + d[0] ;})
    .attr("y", function (d,i) {return d[1] -1 ;})
	.text( function (d, i ) { return labels_schema[i]; })
...
svg.selectAll(".text_name")
	...
	//.attr("text-anchor", "middle")
	.text( function (d, i ) { return labels_name[i].substring(0,14); })
	.attr("fill", "black");

svg.selectAll(".text_update")
	.data(points)
	.enter().append("text")
	.attr("class", "text_update")
    .attr("x", function (d,i) {return textSpacing+ d[0] ;})
    .attr("y", function (d,i) {return d[1] +25;})
	.attr("font-family", "sans-serif")
	.attr("font-size", "8px")
	.text( function (d, i ) { return "LU/" + labels_update[i]; })
	//.attr("font-weight", "bold")
	//.attr("text-anchor", "middle")
	.attr("fill", "black");

svg.selectAll(".text_event")
	.data(points)
	.enter().append("text")
	.attr("class", "text_event")
    .attr("x", function (d,i) {return textSpacing+ d[0] ;})
    .attr("y", function (d,i) {return d[1] +35;})
	.attr("font-family", "sans-serif")
	.attr("font-size", "8px")
	.text( function (d, i ) { return "LE/" + labels_update[i]; })
	//.attr("font-weight", "bold")
	//.attr("text-anchor", "middle")
	.attr("fill", "black");
